                                ...
                                <ul class="standard_dropdown main_nav_dropdown">
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('contact.form') }}">Contact<i class="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col">
                        ...
                        <div class="page_menu_content">
                            ...
                            <ul class="page_menu_nav">
                                ...
                                <li class="page_menu_item"><a href="{{ route('store.post')}}">blog<i class="fa fa-angle-down"></i></a></li>
                                <li class="page_menu_item"><a href="{{ route('contact.page') }}">contact<i class="fa fa-angle-down"></i></a></li>
                            </ul>
                            
                            <div class="menu_contact">
                                <div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{ asset('public/frontend/images/phone_white.png')}}" alt=""></div>+253 77 55 09 08</div>
                                <div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{ asset('public/frontend/images/mail_white.png')}}" alt=""></div><a href="mailto:djibeshop@gmail.com">djibeshop@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                </div>
