...
<html lang="en">
<head>
<title>DjibeShop</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="DjibeShop WebSite">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('public/frontend/images/mail.png')}}" alt=""></div><a href="mailto:djibeshop@gmail.com">{{ $setting->email }}</a></div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Djibouti Ecommerce Website  is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://djibe-shop.com" target="_blank">Daoud Houssein Mohamed</a>
