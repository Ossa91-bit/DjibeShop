  ...
  <div class="container"> 
    <div class="row">
      <div class="col-8 card">
        ...
        <div class="card"> 
        @auth()
        <span class="card-title text-center">{{ auth()->user()->name }}</span>
                    
                @endauth
        @if(auth()->user()->avatar)
                    <img class="img-profile rounded-circle" src="{{ asset('storage/images/users/' . auth()->user()->avatar) }}"
                   
                @else
       <img class="img-profile rounded-circle" src="{{ asset('public/frontend/images/kaziariyan.png') }}" alt="">
                @endif
