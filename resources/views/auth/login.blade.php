...
<div class="contact_form">
    ...
    <a href="{{ url('/auth/redirect/facebook') }}"class="btn btn-block" style="background-color: #1877F2; color: #FFFFFF"><i class="fab fa-facebook-square"></i> Login with Facebook </a>
