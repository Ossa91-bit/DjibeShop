...
@php
 ...
 $hot = DB::table('products')
            ...
            ->where('products.status',1)->where('hot_deal',1)->orderBy('id','desc')->limit(5)
            ->get();
                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item discount">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        ...
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category">{{ $cats->category_name }} </a></div>
                                            <div class="bestsellers_name"><div><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">{{ $row->product_name }}</a></div></div>
                                    ...
                                    <ul class="bestsellers_marks">
                                       <li class="bestsellers_mark bestsellers_discount">${{ $row->selling_price }}<span> </li>
                                ...
                                <div class="bestsellers_item discount">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="{{ asset( $row->image_one )}}" alt=""></div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category">{{ $cats->category_name }}</div>
                                            <div class="bestsellers_name">{{ $row->product_name }}</div>
                                            <div class="rating_r rating_r_4 bestsellers_rating"><i></i><i></i><i></i><i></i><i></i></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="trends_container">
                        ...
                        <div class="trends_text"><p>Special offer for the blessed month of Ramadan !</p></div>
...
@endphp
       ...
       @foreach($buyget as $row)
        ...
        <div class="trends_category"><a href="#">{{ $row->brand_name }}</a></div>
          ...
          <div class="trends_name"><div><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">{{ $row->product_name }}</a></div></div>        
