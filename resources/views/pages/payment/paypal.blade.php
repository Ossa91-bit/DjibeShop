...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;"> 
            ...
            <form action="{{ route('paypal.charge') }}" method="post" id="payment-form">
              @csrf
              <div class="form-row">
...
var paypal = paypal('AREMr5DBWdmclvjgYk-sCnWXGyLLx9RvD4vee9pHU5l6amrwzbiA6DsnW_B0_hEu_SvmRV9QAGvpa_Qq');
...
form.addEventListener('submit', function(event) {
  ...
  paypal.createToken(card).then(function(result) {
    if (result.error) {
...
function paypalTokenHandler(token) {
