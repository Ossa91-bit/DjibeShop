...
class PaymentController extends Controller
{
  ...
  public function StripeCharge(Request $request){
		...
		\Stripe\Stripe::setApiKey('sk_test_51KEeJxB7CtoM7LqHYXqUqjHOC7hse30VWlJLDuOPxE2fDzBQPmO7EJeVGiwXQY3JAts2kjqaKUV3Y3A4VY60QbSz00oZRopthE');
...
// Set your secret key: remember to change this to your live secret key in production
// See your keys here: https://dashboard.stripe.com/account/apikeys
\Paypal\Paypal::setApiKey('EJaKBzSSdZcfR3EFb4rZEWPd2k_5qHOlq2a3VcTSYL2r2S41sS6ovIG2dlIshLcpvo6qsB4FACSQQnUk');
...
$data['paying_amount'] = $charge->amount;
$data['blnc_transection'] = $charge->balance_transaction;
$data['paypal_order_id'] = $charge->metadata->order_id;
$data['shipping'] = $request->shipping;
$data['vat'] = $request->vat;
$data['total'] = $request->total;
$data['payment_type'] = $request->payment_type;
